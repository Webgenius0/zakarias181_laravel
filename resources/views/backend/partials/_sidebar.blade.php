                    ...
                    <!-- <ul class="slide-menu">
                        <li class="sub-slide">
                            ...
                            <ul class="sub-slide-menu">
                                <li><a href="{{ route('admin.cms.home.intro.index') }}" class="sub-slide-item">Hero Banner</a></li>
                                <li><a href="{{ route('admin.cms.home.example.index') }}" class="sub-slide-item">Why choose us</a></li>

                                <li><a href="{{ route('admin.cms.home.service.index') }}" class="sub-slide-item">Services</a></li>
